...
public class Movies_CustomListAdapter extends BaseAdapter {
    ...
    public Movies_CustomListAdapter(Activity activity, List<Movie> movieItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        thumbNail.setImageUrl(m.getPosterURL(), imageLoader);
        ...
        String sViewed= shared_prefs.getString(m.getImdbID(), Tags.SHARED_PREF_NOT_VIEWED);
        viewed.setText(sViewed);

        Button viewButton = (Button) convertView.findViewById(R.id.list_button);
        viewButton.setOnClickListener(new Movie_CustomOnClickListener(position, (Movie) m, activity, viewed));
